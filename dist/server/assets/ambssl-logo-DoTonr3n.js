import { M as useRouter, T as React, U as jsxRuntimeExports, r as reactExports } from "./worker-entry-DPjF8scK.js";
import { R as ReactDOM, L as Link } from "./router-BJlMJuqw.js";
...
const items = [
  ...
  { label: "Fotos", icon: Image, to: "/", tab: "fotos" },
...
function BottomNav({ activeTab }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mx-auto flex max-w-3xl items-stretch justify-between px-2 pt-1.5", children: items.map((it) => {
        const isActive = onAbout ? it.to === "/sobre" : it.to === "/" && it.tab === activeTab;
        const Icon2 = it.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to: it.to,
            search: it.to === "/" && it.tab ? { tab: it.tab } : void 0,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `relative flex h-9 w-12 items-center justify-center rounded-full transition-colors ${isActive ? "text-primary" : "text-muted-foreground"}`,
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "relative h-5 w-5", strokeWidth: 2.2 })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: isActive ? "text-primary" : "text-muted-foreground", children: it.label })
            ]
          }
        ) }, it.label);
      }) })
...
function useServiceWorker() {
  reactExports.useEffect(() => {
    ...
    navigator.serviceWorker.register("/sw.js", { scope: "/" }).then((reg) => {
      setInterval(() => reg.update(), 60 * 60 * 1e3);
    }).catch((err) => {
      console.warn("[SW] Registration failed:", err);
    });
  }, []);
}
function AppShell({ children, activeTab }) {
  useServiceWorker();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto max-w-3xl px-3 pb-28 pt-2", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { activeTab }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { position: "top-center", richColors: true })
  ] });
}
const logo = "/assets/ambssl-logo-CpAmYUr2.png";
export {
  camelToDash as $,
  AppShell as A,
  memo as B,
  flushKeyframeResolvers as C,
  isNumericalString as D,
  transformProps as E,
  resolveVariantFromProps as F,
  transformPropOrder as G,
  Heart as H,
  motionValue as I,
  isMotionValue as J,
  KeyframeResolver as K,
  optimizedAppearDataAttribute as L,
  MotionGlobalConfig as M,
  NativeAnimation as N,
  isZeroValueString as O,
  getAnimatableNone as P,
  findDimensionValueType as Q,
  containsCSSVariable as R,
  positionalValues as S,
  isNumOrPxType as T,
  defaultTransformValue as U,
  VisualElement as V,
  WithPromise as W,
  readTransformValue as X,
  isCSSVariableName as Y,
  buildHTMLStyles as Z,
  scrapeMotionValuesFromProps$1 as _,
  invariant as a,
  createBox as a0,
  scrapeMotionValuesFromProps as a1,
  buildSVGAttrs as a2,
  isSVGTag as a3,
  getDefaultValueType as a4,
  isVariantLabel as a5,
  variantProps as a6,
  isAnimationControls as a7,
  variantPriorityOrder as a8,
  MotionConfigContext as a9,
  useConstant as aa,
  PresenceContext as ab,
  useIsomorphicLayoutEffect as ac,
  LayoutGroupContext as ad,
  loadFeatures as ae,
  LazyContext as af,
  isSVGComponent as ag,
  toast as ah,
  percent as ai,
  px as aj,
  addUniqueItem as ak,
  removeItem as al,
  SubscriptionManager as am,
  frameSteps as an,
  microtask as ao,
  createDelta as ap,
  resolveMotionValue as aq,
  scaleCorrectors as ar,
  isRefObject as as,
  SwitchLayoutGroupContext as at,
  createMotionProxy as au,
  hex as b,
  createLucideIcon as c,
  isCSSVariableToken as d,
  color as e,
  complex as f,
  analyseComplexValue as g,
  hsla as h,
  isBezierDefinition as i,
  frameData as j,
  cancelFrame as k,
  logo as l,
  mixNumber as m,
  ...
  clamp as q,
  rgba as r,
  generateLinearEasing as s,
  time as t,
  secondsToMilliseconds as u,
  velocityPerSecond as v,
  getFinalKeyframe as w,
  setStyle as x,
  isGenerator as y,
  acceleratedValues as z
};
