import { r as reactExports, U as jsxRuntimeExports, a0 as React } from "./worker-entry-DPjF8scK.js";
import { S as Subscribable, p as pendingThenable, r as resolveQueryBoolean, s as shallowEqualObjects, a as resolveStaleTime, n as noop, e as environmentManager, i as isValidTimeout, t as timeUntilStale, b as timeoutManager, f as focusManager, c as fetchState, d as replaceData, g as notifyManager, h as infiniteQueryBehavior, j as hasPreviousPage, k as hasNextPage, l as shouldThrowError, u as useQueryClient, m as reactDomExports, R as ReactDOM, o as Route, q as useNavigate } from "./router-BJlMJuqw.js";
import { c as createLucideIcon, n as noop$1, i as isBezierDefinition, a as invariant, m as mixNumber$1, r as rgba, h as hsla, b as hex, d as isCSSVariableToken, e as color, f as complex, g as analyseComplexValue, j as frameData, t as time, k as cancelFrame, o as frame, p as millisecondsToSeconds, q as clamp, s as generateLinearEasing, u as secondsToMilliseconds, v as velocityPerSecond, M as MotionGlobalConfig, W as WithPromise, w as getFinalKeyframe, N as NativeAnimation, x as setStyle, y as isGenerator, z as acceleratedValues, B as memo, K as KeyframeResolver, C as flushKeyframeResolvers, D as isNumericalString, E as transformProps, F as resolveVariantFromProps, G as transformPropOrder, I as motionValue, J as isMotionValue, L as optimizedAppearDataAttribute, O as isZeroValueString, P as getAnimatableNone, Q as findDimensionValueType, R as containsCSSVariable, S as positionalValues, T as isNumOrPxType, V as VisualElement, U as defaultTransformValue, X as readTransformValue, Y as isCSSVariableName, Z as buildHTMLStyles, _ as scrapeMotionValuesFromProps, $ as camelToDash, a0 as createBox, a1 as scrapeMotionValuesFromProps$1, a2 as buildSVGAttrs, a3 as isSVGTag, a4 as getDefaultValueType, a5 as isVariantLabel, a6 as variantProps, a7 as isAnimationControls, a8 as variantPriorityOrder, a9 as MotionConfigContext, aa as useConstant, ab as PresenceContext, ac as useIsomorphicLayoutEffect$1, ad as LayoutGroupContext, ae as loadFeatures, af as LazyContext, ag as isSVGComponent, l as logo, ah as toast, H as Heart, A as AppShell } from "./ambssl-logo-DoTonr3n.js";
...
const ImageOff = createLucideIcon("image-off", __iconNode$7);
...
function GalleryHeader({ onOpenFilters, totalCount }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 glass-bar border-b border-border safe-top", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-3xl items-center gap-3 px-4 py-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-primary/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: logo,
        alt: "Logo AMBSSL",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "truncate text-[15px] font-semibold leading-tight text-foreground", children: "Galeria AMBSSL" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "truncate text-[11px] leading-tight text-muted-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersHorizontal, { className: "h-[18px] w-[18px]" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "h-[18px] w-[18px]" })
      }
    )
  ] }) });
}
...
function G(e, t, n) {
  const [r2, s] = reactExports.useState({ columns: 0, gap: 1 });
...
function T({
  ...
  const [i, u] = reactExports.useState(/* @__PURE__ */ new Map()), o = reactExports.useMemo(() => C(n.columns), [n.columns]), a = reactExports.useMemo(() => C(n.gap), [n.gap]), { columns: l, gap: d } = G(n.media, o, a), w = E(l, d);
  if (!l) return null;
  const v = n.useBalancedLayout ? j(e, l, (m) => i.get(m) ?? 0) : S(Q(e, l), l);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(r2, { ...s, style: w, children: v.map((m, A) => /* @__PURE__ */ jsxRuntimeExports.jsx(H, { gap: d, children: m.map((h, p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ref: (g) => {
...
function Q(e = [], t = 3) {
  const n = [];
  for (let r2 = 0; r2 < e.length; r2 += t) {
    const s = e.slice(r2, r2 + t);
    n.push(s);
  }
  return n;
}
function S(e = [], t = 3) {
  ...
  for (let r2 = 0; r2 < t; r2++)
    for (let s = 0; s < e.length; s += 1)
      e[s][r2] && n[r2].push(e[s][r2]);
  return n;
}
function j(e, t, n) {
  const r2 = Array.from({ length: t }, () => []), s = new Array(t).fill(0);
  for (const i of e) {
    let u = 0, o = s[0];
    for (let a = 1; a < t; a++)
      s[a] < o && (o = s[a], u = a);
...
function useNetwork() {
  const [info, setInfo] = reactExports.useState(() => read$1());
  reactExports.useEffect(() => {
    const c = navigator.connection ?? null;
    if (!c?.addEventListener) return;
    const update2 = () => setInfo(read$1());
    c.addEventListener("change", update2);
    return () => c.removeEventListener?.("change", update2);
  }, []);
  const isSlow = info.saveData || info.effectiveType === "slow-2g" || info.effectiveType === "2g" || info.downlink < 1;
  return { ...info, isSlow };
}
function useDoubleTap({ threshold = 280, onSingleTap, onDoubleTap }) {
  const lastTap = reactExports.useRef(0);
  const singleTimer = reactExports.useRef();
...
const MediaCard = reactExports.memo(function MediaCard2({
  item,
  isFavorite,
  onOpen,
  onToggleFav,
  ...
  const srcSet = saveData ? void 0 : `${item.thumbUrl} 360w, ${item.gridUrl} 640w`;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            "aria-label": label,
            style: item.dominantColor ? { backgroundColor: item.dominantColor } : void 0,
            children: [
              !loaded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 shimmer opacity-60", "aria-hidden": true }),
              visible && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  ...
                  className: `relative h-full w-full object-cover transition-opacity duration-500 ${loaded ? "opacity-100" : "opacity-0"} group-active:scale-[0.98] group-active:duration-150`,
                  draggable: false
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none absolute inset-x-0 top-0 flex items-start justify-between p-2", children: [
                item.isFeatured ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-highlight/95 px-2 py-0.5 text-[10px] font-semibold text-highlight-foreground shadow-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-3 w-3", "aria-hidden": true }),
                  " Destaque"
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
                item.type === "video" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "inline-flex h-6 w-6 items-center justify-center rounded-full bg-black/55 text-white backdrop-blur-sm",
                    "aria-hidden": true,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-3.5 w-3.5 fill-white" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-black/55 to-transparent" }),
              item.type === "video" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pointer-events-none absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-12 w-12 items-center justify-center rounded-full bg-white/90 text-primary shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-5 w-5 fill-current", "aria-hidden": true }) }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function MediaGrid({
  ...
  reactExports.useEffect(() => {
    ...
    io.observe(el);
    return () => io.disconnect();
  }, [hasNextPage2, isFetchingNextPage, onLoadMore]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      T,
      {
        ...
        render: (item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          MediaCard,
          {
            item,
    ...
    hasNextPage2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: sentinel, className: "flex items-center justify-center py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        role: "status",
        "aria-live": "polite",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-2 w-2 animate-pulse rounded-full bg-primary" }),
...
const SheetContent = reactExports.forwardRef(({ side = "right", className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetPortal, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { ref, className: cn(sheetVariants({ side }), className), ...props, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { className: "sr-only", children: "Painel de conteúdo" }),
...
function FilterSheet({ open, onOpenChange, filter, setFilter, sort, setSort }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "bottom", className: "rounded-t-3xl border-t-0 pb-safe", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-lg", children: "Filtrar e ordenar" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: "Mostrar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: filters.map((f) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `flex w-full items-center justify-between rounded-xl px-3 py-3 text-left text-sm font-medium transition-colors ${active ? "bg-highlight/30 text-primary" : "hover:bg-accent"}`,
              children: [
                f.label,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: "Ordenar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: sorts.map((s) => {
...
function LoadingSkeleton() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    T,
    {
      ...
      render: (ar, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-highlight/30 text-primary", children: icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 max-w-xs text-sm text-muted-foreground", children: description })
      ]
    }
  );
}
function OfflineBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex w-full items-center gap-2 rounded-xl bg-highlight/95 px-3 py-2 text-[13px] font-medium text-highlight-foreground shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "h-4 w-4 shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sem internet no momento. Mostrando itens já carregados." })
      ] })
    }
  );
}
const pic = (seed, w, h) => `https://picsum.photos/seed/ambssl-${seed}/${w}/${h}`;
const sampleVideos = [
...
function buildItems() {
  ...
  const total = 44;
  let videoIdx = 0;
  const startDate = (/* @__PURE__ */ new Date("2025-04-20T12:00:00Z")).getTime();
  for (let i = 0; i < total; i++) {
    const isVideo = i % 6 === 4;
    const [w, h] = pickDims(i);
    const seed = `${i + 1}`;
    const createdAt = new Date(startDate - i * 1e3 * 60 * 60 * 8).toISOString();
    const caption = captions[i % captions.length];
    const author = authors[i % authors.length];
    const isFeatured = i % 7 === 0;
    const color2 = dominantColors[i % dominantColors.length];
    const ratio = (px) => Math.max(1, Math.round(px * h / w));
    const thumb = (px) => pic(seed, px, ratio(px));
    const base = {
      id: `m-${i + 1}`,
      width: w,
      height: h,
...
const MOCK_MEDIA = buildItems();
const PAGE_SIZE = 14;
async function fetchGalleryFeed(params) {
  return fetchFromMock(params);
}
function fetchFromMock(params) {
...
function useGalleryFeed({ tab = "todos", sort = "recent", favoriteIds }) {
  const query = useInfiniteQuery({
    queryKey: ["gallery", { tab, sort }],
    queryFn: ({ pageParam }) => fetchGalleryFeed({ tab, sort, cursor: pageParam, favoriteIds }),
...
function useFavorites() {
  const [favs, setFavs] = reactExports.useState(
    () => typeof window === "undefined" ? /* @__PURE__ */ new Set() : getCurrent()
  );
  reactExports.useEffect(() => {
    const l = (s) => setFavs(new Set(s));
    listeners.push(l);
  ...
  const isFav = reactExports.useCallback((id2) => favs.has(id2), [favs]);
  return { favorites: favs, toggle, isFav };
}
function useOnline() {
  const [online, setOnline] = reactExports.useState(true);
  reactExports.useEffect(() => {
    const update2 = () => setOnline(navigator.onLine);
    update2();
    window.addEventListener("online", update2);
    window.addEventListener("offline", update2);
    return () => {
      window.removeEventListener("online", update2);
      window.removeEventListener("offline", update2);
    };
  }, []);
  return online;
}
const MediaViewer = reactExports.lazy(() => import("./MediaViewer-DF_qA8Cb.js").then((m) => ({
  default: m.MediaViewer
})));
function GalleryPage() {
  const search = Route.useSearch();
  const navigate = useNavigate();
  const tab = search.tab ?? "todos";
  ...
  const setViewerIndex = (i) => {
    const id2 = items[i]?.id;
    if (!id2) return;
    navigate({
      to: "/",
      search: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { activeTab: tab, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryHeader, { onOpenFilters: () => setFiltersOpen(true), totalCount: total }),
    !online && /* @__PURE__ */ jsxRuntimeExports.jsx(OfflineBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-1 pt-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between px-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[13px] font-medium text-muted-foreground", children: tab === "favoritos" ? "Mídias salvas no seu dispositivo" : "Fotos e vídeos da comunidade" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: "Toque para ampliar" })
      ] }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSkeleton, {}) : items.length === 0 ? tab === "favoritos" ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-6 w-6" }), title: "Nenhum favorito ainda", description: "Toque duas vezes em uma mídia ou no coração para salvar nos favoritos." }) : !online ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "h-6 w-6" }), title: "Sem internet no momento", description: "Mostrando o que já está em cache. Quando voltar, novas mídias aparecem." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ImageOff, { className: "h-6 w-6" }), title: "Nada por aqui", description: "Não encontramos mídias para este filtro." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MediaGrid, { items, favorites, onOpen: openViewer, onToggleFav: toggle, hasNextPage: !!hasNextPage2, isFetchingNextPage, onLoadMore: () => fetchNextPage() })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FilterSheet, { open: filtersOpen, onOpenChange: setFiltersOpen, filter: tab, setFilter: handleSetFilter, sort, setSort: handleSetSort }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(LazyMotion, { features: domAnimation, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: viewerIndex >= 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-[var(--viewer-bg)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-white/60" }) }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MediaViewer, { items, index: viewerIndex, onClose: closeViewer, onIndexChange: setViewerIndex, isFavorite: isFav, onToggleFav: toggle }) }) }) })
  ] });
}
...
export {
  usePresence$1 as A,
  gestureAnimations as B,
  animations as C,
  createDomVisualElement as D,
  useNetwork as E,
  Feature as F,
  ...
  X,
  isObject as a,
  animateMotionValue as b,
  circOut as c,
  transformBox as d,
  hasScale as e,
  applyBoxDelta as f,
  getValueTransition as g,
  hasTransform as h,
  isDragging as i,
  has2DTranslate as j,
  applyTreeDeltas as k,
  getOptimisedAppearId as l,
  addDomEvent as m,
  addPointerInfo as n,
  isPrimaryPointer as o,
  progress as p,
  extractEventInfo as q,
  resolveElements as r,
  scalePoint as s,
  translateAxis as t,
  pipe as u,
  measurePageBox as v,
  convertBoxToBoundingBox as w,
  convertBoundingBoxToBox as x,
  addValueToWillChange as y,
