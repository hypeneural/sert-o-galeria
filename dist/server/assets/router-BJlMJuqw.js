...
const appCss = "/assets/styles-CR6y-WN_.css";
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fotos e vídeos da comunidade do Sertão de Santa Luzia" },
...
const $$splitComponentImporter$1 = () => import("./sobre-B9WJVS6V.js");
const Route$1 = createFileRoute("/sobre")({
  head: () => ({
    meta: [{
      title: "Sobre — Galeria AMBSSL"
    }, {
      name: "description",
      content: "Conheça a Associação de Moradores do Bairro Sertão de Santa Luzia, Porto Belo - SC."
    }, {
      property: "og:title",
      content: "Sobre a AMBSSL"
    }, {
...
ZodOptional.create;
ZodNullable.create;
const $$splitComponentImporter = () => import("./index-jb9gLq58.js").then((n) => n.H);
const searchSchema = objectType({
  tab: enumType(["todos", "fotos", "videos", "favoritos"]).optional(),
  media: stringType().optional()
});
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Fotos e vídeos da comunidade do Sertão de Santa Luzia, Porto Belo. Galeria pública da Associação de Moradores AMBSSL."
    }, {
      property: "og:title",
      content: "Galeria AMBSSL — Sertão de Santa Luzia"
    }, {
      property: "og:description",
...
const SobreRoute = Route$1.update({
  id: "/sobre",
  path: "/sobre",
...
export {
  ...
  focusManager as f,
  notifyManager as g,
  infiniteQueryBehavior as h,
  isValidTimeout as i,
  hasPreviousPage as j,
  hasNextPage as k,
